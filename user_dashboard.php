...
<header>
    ...
    <div class="profile-menu-container">
        ...
        if (isset($_SESSION['username'])):
            ...
            require_once 'config.php'; // Assure-toi d'inclure ton fichier de connexion
            ...
            // Set profile image
            $profileImg = isset($user['profile_img']) && !empty($user['profile_img']) ? 'uploads/' . $user['profile_img'] : 'uploads/default-profile.png';
        ?>
            <div class="profile-menu">
            <img src="uploads/<?php echo htmlspecialchars($profile_img); ?>" alt="Profile" class="profile-icon" onclick="toggleProfileMenu()">
